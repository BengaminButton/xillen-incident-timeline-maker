# xillen-incident-timeline-maker

Сбор таймлайнов инцидентов из артефактов.
...
## Установка
- Клонируйте репозиторий: git clone https://github.com/BengaminButton/xillen-incident-timeline-maker.git
- Перейдите в каталог: cd xillen-incident-timeline-maker
